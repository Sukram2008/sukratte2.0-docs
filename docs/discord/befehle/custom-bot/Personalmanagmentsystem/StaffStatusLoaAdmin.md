...
Befehl: **`/staff-status loa admin`**

:::warning Eingriff
Nur für Korrekturen nutzen, da dieser Befehl bestehende Nutzeranträge überschreibt.
:::

### Erforderliche Optionen
- **`user:`** Das Teammitglied, dessen LOA bearbeitet werden soll.
