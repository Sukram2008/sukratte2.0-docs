...
- **`max-selections:`** Maximale Anzahl an Auswahlmöglichkeiten pro Person. Standard ist 1, 0 bedeutet unbegrenzt.
...
<div style={{display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '10px'}}>
  ...
  <div style={{display: 'flex', flexWrap: 'wrap', gap: '8px'}}>
    ...
    <span style={{backgroundColor: '#2ecc71', color: '#fff', padding: '2px 8px', borderRadius: '4px', fontSize: '0.85em'}}>💼 | Support-Manager</span>
    ...
    <span style={{backgroundColor: '#3498db', color: '#fff', padding: '2px 8px', borderRadius: '4px', fontSize: '0.85em'}}>☎️ | Supporter</span>
