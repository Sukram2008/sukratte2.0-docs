      ...
      items: [
        {
          ...
          items: [
            ...
            { type: 'category', label: 'Betterstatus', items: ['discord/befehle/Betterstatus/Status'] },
            { type: 'category', label: 'Bewerbungen', items: ['discord/befehle/Bewerbungen/Apply'] },
            { type: 'category', label: 'Color me', items: ['discord/befehle/Color-me/Color-meManage', 'discord/befehle/Color-me/Color-meRemove'] },
            { type: 'category', label: 'Erinnerungen', items: ['discord/befehle/Erinnerungen/RemindMe'] },
            { type: 'category', label: 'Errate die Nummer', items: ['discord/befehle/Errate-die-Nummer/GuessStatus'] },
            { type: 'category', label: 'Fun-Befehle', items: ['discord/befehle/Fun-Befehle/Interaktions-Befehle/FunHug', 'discord/befehle/Fun-Befehle/Interaktions-Befehle/FunPat', 'discord/befehle/Fun-Befehle/Interaktions-Befehle/FunKiss', 'discord/befehle/Fun-Befehle/Interaktions-Befehle/FunSlap', 'discord/befehle/Fun-Befehle/Random-Befehle/RandomNumber', 'discord/befehle/Fun-Befehle/Random-Befehle/RandomCoinflip', 'discord/befehle/Fun-Befehle/Random-Befehle/RandomDice', 'discord/befehle/Fun-Befehle/Random-Befehle/Random8Ball', 'discord/befehle/Fun-Befehle/Random-Befehle/RandomIkea-name'] },
            { type: 'category', label: 'Geburtstags-Kalender', items: ['discord/befehle/Geburtstags-Kalender/Nutzer-Befehle/BirthdayStatus', 'discord/befehle/Geburtstags-Kalender/Nutzer-Befehle/BirthdaySet', 'discord/befehle/Geburtstags-Kalender/Nutzer-Befehle/BirthdayDelete'] },
            { type: 'category', label: 'Gewinnspiele', items: ['discord/befehle/Gewinnspiele/Nutzer-Befehle/GMessages'] },
            { type: 'category', label: 'Info-Befehle', items: ['discord/befehle/Info-Befehle/InfoUser', 'discord/befehle/Info-Befehle/InfoServer'] },
            { type: 'category', label: 'Level-System', items: ['discord/befehle/Level-System/Nutzer-Befehle/LevelProfile', 'discord/befehle/Level-System/Nutzer-Befehle/LevelLeaderboard'] },
            { type: 'category', label: 'Minispiele', items: ['discord/befehle/Minispiele/Duel', 'discord/befehle/Minispiele/Rock-Paper-Scissors', 'discord/befehle/Minispiele/Tic-Tac-Toe'] },
            { type: 'category', label: 'Sicherheit', items: ['discord/befehle/Moderation-und-Sicherheit/Nutzer-Befehle/ModerateReport'] },
            { type: 'category', label: 'Sammel die Codes', items: ['discord/befehle/Sammel-die-Codes/Nutzer-Befehle/HuntTheCodeProfile', 'discord/befehle/Sammel-die-Codes/Nutzer-Befehle/HuntTheCodeLeaderboard', 'discord/befehle/Sammel-die-Codes/Nutzer-Befehle/HuntTheCodeRedeem'] },
            { type: 'category', label: 'Umfragen', items: ['discord/befehle/Umfragen/PollUserInfos'] },
            { type: 'category', label: 'Vorschläge', items: ['discord/befehle/Vorschläge/Nutzer-Befehle/SuggestionSubmit'] },
      ...
      items: [
        {
          ...
          items: [
            ...
            { type: 'category', label: 'Einladungsverfolgung', items: ['discord/befehle/Einladungsverfolgung/TraceInvites'] },
            { type: 'category', label: 'Errate die Nummer', items: ['discord/befehle/Errate-die-Nummer/GuessCreate', 'discord/befehle/Errate-die-Nummer/GuessEnd'] },
            { type: 'category', label: 'Geburtstags-Kalender', items: ['discord/befehle/Geburtstags-Kalender/Admin-Befehle/ManageBirthdayUnlock', 'discord/befehle/Geburtstags-Kalender/Admin-Befehle/ManageBirthdayLock', 'discord/befehle/Geburtstags-Kalender/Admin-Befehle/ManageBirthdaySet', 'discord/befehle/Geburtstags-Kalender/Admin-Befehle/ManageBirthdayRemove'] },
            { type: 'category', label: 'Gewinnspiele', items: ['discord/befehle/Gewinnspiele/Team-Befehle/GmanageStart', 'discord/befehle/Gewinnspiele/Team-Befehle/GmanageReroll', 'discord/befehle/Gewinnspiele/Team-Befehle/GmanageEnd'] },
            { type: 'category', label: 'Level-System', items: ['discord/befehle/Level-System/Admin-Befehle/ManageLevelSet', 'discord/befehle/Level-System/Admin-Befehle/ManageLevelAdd', 'discord/befehle/Level-System/Admin-Befehle/ManageLevelRemove', 'discord/befehle/Level-System/Admin-Befehle/ManageLevelXPSet', 'discord/befehle/Level-System/Admin-Befehle/ManageLevelXPAdd', 'discord/befehle/Level-System/Admin-Befehle/ManageLevelXPRemove', 'discord/befehle/Level-System/Admin-Befehle/ManageLevelResetXP'] },
            { type: 'category', label: 'Massenrolle', items: ['discord/befehle/Massenrolle/MassroleAdd', 'discord/befehle/Massenrolle/MassroleRemove', 'discord/befehle/Massenrolle/MassroleRemoveAll'] },
            { type: 'category', label: 'Moderation & Sicherheit', items: ['discord/befehle/Moderation-und-Sicherheit/Moderations-Aktionen/ModerateActions', 'discord/befehle/Moderation-und-Sicherheit/Moderations-Aktionen/ModerateWarn', 'discord/befehle/Moderation-und-Sicherheit/Moderations-Aktionen/ModerateRevokeWarn', 'discord/befehle/Moderation-und-Sicherheit/Moderations-Aktionen/ModerateMute', 'discord/befehle/Moderation-und-Sicherheit/Moderations-Aktionen/ModerateUnmute', 'discord/befehle/Moderation-und-Sicherheit/Moderations-Aktionen/ModerateKick', 'discord/befehle/Moderation-und-Sicherheit/Moderations-Aktionen/ModerateBan', 'discord/befehle/Moderation-und-Sicherheit/Moderations-Aktionen/ModerateUnban', 'discord/befehle/Moderation-und-Sicherheit/Moderations-Aktionen/ModerateClear', 'discord/befehle/Moderation-und-Sicherheit/Moderations-Aktionen/ModerateQuarantine', 'discord/befehle/Moderation-und-Sicherheit/Moderations-Aktionen/ModerateUnquarantine', 'discord/befehle/Moderation-und-Sicherheit/Moderations-Aktionen/ModerateChannelMute', 'discord/befehle/Moderation-und-Sicherheit/Moderations-Aktionen/ModerateRemoveChannelMute', 'discord/befehle/Moderation-und-Sicherheit/Kanal-Verwaltung/ModerateLock', 'discord/befehle/Moderation-und-Sicherheit/Kanal-Verwaltung/ModerateUnlock', 'discord/befehle/Moderation-und-Sicherheit/Kanal-Verwaltung/ModerateLockdown', 'discord/befehle/Moderation-und-Sicherheit/Notizen/ModerateNotesView', 'discord/befehle/Moderation-und-Sicherheit/Notizen/ModerateNotesCreate', 'discord/befehle/Moderation-und-Sicherheit/Notizen/ModerateNotesEdit', 'discord/befehle/Moderation-und-Sicherheit/Notizen/ModerateNotesDelete'] },
            { type: 'category', label: 'Partner-Liste', items: ['discord/befehle/Partner-Liste/PartnerListAdd', 'discord/befehle/Partner-Liste/PartnerListEdit', 'discord/befehle/Partner-Liste/PartnerListDelete'] },
            { type: 'category', label: 'Ping-Schutz', items: ['discord/befehle/Ping-Schutz/PingProtectionUserPanel', 'discord/befehle/Ping-Schutz/PingProtectionListProtected', 'discord/befehle/Ping-Schutz/PingProtectionListWhitelisted', 'discord/befehle/Ping-Schutz/PingProtectionUserHistory', 'discord/befehle/Ping-Schutz/PingProtectionUserActionsHistory'] },
            { type: 'category', label: 'Sammel die Codes', items: ['discord/befehle/Sammel-die-Codes/Admin-Befehle/HuntTheCodeAdminReport', 'discord/befehle/Sammel-die-Codes/Admin-Befehle/HuntTheCodeAdminCreateCode', 'discord/befehle/Sammel-die-Codes/Admin-Befehle/HuntTheCodeAdminEnd'] },
            { type: 'category', label: 'Team-Ziele', items: ['discord/befehle/Teammitglieder-Ziele/TeamGoalsHistory', 'discord/befehle/Teammitglieder-Ziele/TeamGoalsProgress', 'discord/befehle/Teammitglieder-Ziele/TeamGoalsVoiceProgress'] },
            { type: 'category', label: 'Temporäre Channel', items: ['discord/befehle/Temporäre-Channel/TempChannelMode', 'discord/befehle/Temporäre-Channel/TempChannelAddUser', 'discord/befehle/Temporäre-Channel/TempChannelRemoveUser', 'discord/befehle/Temporäre-Channel/TempChannelListUsers', 'discord/befehle/Temporäre-Channel/TempChannelEdit'] },
            { type: 'category', label: 'Umfragen', items: ['discord/befehle/Umfragen/PollCreate', 'discord/befehle/Umfragen/PollEnd'] },
            { type: 'category', label: 'Vorschläge', items: ['discord/befehle/Vorschläge/Team-Befehle/SuggestionAccept', 'discord/befehle/Vorschläge/Team-Befehle/SuggestionDeny'] },
