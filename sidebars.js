      ...
      items: [
        {
          ...
          items: [
            { type: 'category', label: 'AFK-System', items: ['nutzer-bereich/AFK-System/AFK-Befehle/AFKStart', 'nutzer-bereich/AFK-System/AFK-Befehle/AFKEnd'] },
            { type: 'category', label: 'Anonymer Chat', items: ['nutzer-bereich/Anonymer-Chat/Nutzer-Befehle/AnonymousMessage'] },
            { type: 'category', label: 'Betterstatus', items: ['nutzer-bereich/Betterstatus/Status'] },
            { type: 'category', label: 'Bewerbungen', items: ['nutzer-bereich/Bewerbungen/Apply'] },
            { type: 'category', label: 'Color me', items: ['nutzer-bereich/Color-me/Color-meManage', 'nutzer-bereich/Color-me/Color-meRemove'] },
            { type: 'category', label: 'Erinnerungen', items: ['nutzer-bereich/Erinnerungen/RemindMe'] },
            { type: 'category', label: 'Errate die Nummer', items: ['nutzer-bereich/Errate-die-Nummer/GuessStatus'] },
            { type: 'category', label: 'Fun-Befehle', items: ['nutzer-bereich/Fun-Befehle/Interaktions-Befehle/FunHug', 'nutzer-bereich/Fun-Befehle/Interaktions-Befehle/FunPat', 'nutzer-bereich/Fun-Befehle/Interaktions-Befehle/FunKiss', 'nutzer-bereich/Fun-Befehle/Interaktions-Befehle/FunSlap', 'nutzer-bereich/Fun-Befehle/Random-Befehle/RandomNumber', 'nutzer-bereich/Fun-Befehle/Random-Befehle/RandomCoinflip', 'nutzer-bereich/Fun-Befehle/Random-Befehle/RandomDice', 'nutzer-bereich/Fun-Befehle/Random-Befehle/Random8Ball', 'nutzer-bereich/Fun-Befehle/Random-Befehle/RandomIkea-name'] },
            { type: 'category', label: 'Geburtstags-Kalender', items: ['nutzer-bereich/Geburtstags-Kalender/Nutzer-Befehle/BirthdayStatus', 'nutzer-bereich/Geburtstags-Kalender/Nutzer-Befehle/BirthdaySet', 'nutzer-bereich/Geburtstags-Kalender/Nutzer-Befehle/BirthdayDelete'] },
            { type: 'category', label: 'Gewinnspiele', items: ['nutzer-bereich/Gewinnspiele/Nutzer-Befehle/GMessages'] },
            { type: 'category', label: 'Info-Befehle', items: ['nutzer-bereich/Info-Befehle/InfoUser', 'nutzer-bereich/Info-Befehle/InfoServer'] },
            { type: 'category', label: 'Level-System', items: ['nutzer-bereich/Level-System/Nutzer-Befehle/LevelProfile', 'nutzer-bereich/Level-System/Nutzer-Befehle/LevelLeaderboard'] },
            { type: 'category', label: 'Minispiele', items: ['nutzer-bereich/Minispiele/Duel', 'nutzer-bereich/Minispiele/Rock-Paper-Scissors', 'nutzer-bereich/Minispiele/Tic-Tac-Toe'] },
            { type: 'category', label: 'Sicherheit', items: ['nutzer-bereich/Moderation-und-Sicherheit/Nutzer-Befehle/ModerateReport'] },
            { type: 'category', label: 'Sammel die Codes', items: ['nutzer-bereich/Sammel-die-Codes/Nutzer-Befehle/HuntTheCodeProfile', 'nutzer-bereich/Sammel-die-Codes/Nutzer-Befehle/HuntTheCodeLeaderboard', 'nutzer-bereich/Sammel-die-Codes/Nutzer-Befehle/HuntTheCodeRedeem'] },
            { type: 'category', label: 'Umfragen', items: ['nutzer-bereich/Umfragen/PollUserInfos'] },
            { type: 'category', label: 'Vorschläge', items: ['nutzer-bereich/Vorschläge/Nutzer-Befehle/SuggestionSubmit'] },
            { type: 'category', label: 'Wirtschaftssystem', items: ['nutzer-bereich/Wirtschaftssystem/Finanzen/EconomyBalance', 'nutzer-bereich/Wirtschaftssystem/Finanzen/EconomyDeposit', 'nutzer-bereich/Wirtschaftssystem/Geldquellen/EconomyCrime', 'nutzer-bereich/Wirtschaftssystem/Geldquellen/EconomyDaily', 'nutzer-bereich/Wirtschaftssystem/Geldquellen/EconomyRob', 'nutzer-bereich/Wirtschaftssystem/Geldquellen/EconomyWork'] },
          ],
        },
